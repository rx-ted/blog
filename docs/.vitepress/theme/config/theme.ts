...
//   import {checkConfig} from '../utils/node/theme'
import { patchVPConfig, patchVPThemeConfig } from '../utils/node/theme'
...
function checkConfig(cfg: Partial<Theme.BlogConfig>) {
