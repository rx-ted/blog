...
public class RedisCache implements Cache {
    ...
    public void put(Object key, Object value, Long exp, TimeUnit timeUnit) {
        redisTemplate.opsForValue().set((String) key, value, exp, timeUnit);
    }
    ...
    public void putHash(Object key, Object hashKey, Object hashValue) {
        redisTemplate.opsForHash().put((String) key, hashKey, hashValue);
    }
    ...
    public Object getHash(Object key, Object hashKey) {
        return redisTemplate.opsForHash().get((String) key, hashKey);
    }

    @Override
    public Map<Object, Object> getHash(Object key) {
        return this.redisTemplate.opsForHash().entries((String) key);
    }
    ...
    public Long cumulative(Object key, Object value) {
        ...
        // add 方法对应 PFADD 命令
        return operations.add((String) key, value);
    ...
    public Long counter(Object key) {
        ...
        // add 方法对应 PFCOUNT 命令
        return operations.size((String) key);
    }
    ...
    public Long mergeCounter(Object... key) {
        HyperLogLogOperations<String, Object> operations = redisTemplate.opsForHyperLogLog();
        // 计数器合并累加
        return operations.union((String) key[0], Arrays.copyOf(key, key.length, String[].class));
    }
