...
import { useArticles, useCleanUrls, useFormatShowDate, useRecommendConfig, useShowRecommend } from '@/theme/blog'
...
<template>
  <div v-if="show && (recommendList.length || emptyText)" class="recommend" :class="{ card: sidebarStyle === 'card' }"
    ...
    <!-- 文章列表 -->
    <ol v-if="currentWikiData.length" :class="{
      'hide-num': !showNum,
