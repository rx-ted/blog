...
import asia.rxted.blog.config.properties.OssConfigProperties;
...
public class OssUploadStrategyImpl extends AbstractUploadStrategyImpl {
    ...
    private OSS getOssClient() {
        return new OSSClientBuilder().build(ossConfigProperties.getEndpoint(), ossConfigProperties.getAccessKeyId(),
