...
declare namespace githubConfig {
    interface Content {
        message: string;
        committer: {
            name: string;
    ...
    interface GetRepoContent {
        owner: string;
        repo: string;
        path: string;
    }
    interface UpdateRepoContent {
        owner: string;
        repo: string;
        path?: string;
        content: {
...
declare function defineLocaleConfig(cfg: Omit<Theme.BlogConfig, 'locales' | 'pagesData'>): Omit<Theme.BlogConfig, "pagesData" | "locales">;
